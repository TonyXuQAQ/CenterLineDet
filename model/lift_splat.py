...
from .base import LSSCamEncoder, BevEncode
...
class LiftSplat(nn.Module):
    def __init__(self, data_conf, # grid_conf, data_aug_conf,
             instance_seg, embedded_dim):
        super(LiftSplat, self).__init__()
        self.grid_conf = data_conf
        ...
        self.camencode = LSSCamEncoder(self.D, self.camC, self.downsample)
        self.bevencode = BevEncode(inC=self.camC, outC=data_conf['num_channels'], instance_seg=instance_seg, embedded_dim=embedded_dim)
