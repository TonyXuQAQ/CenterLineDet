...
train_set1 = [x for i,x in enumerate(train_set) if i%2==0] # for segmentation 1/2
train_set2 = [x for i,x in enumerate(train_set) if i%2!=0] # for sampling 1/2

with open('./split.json','w') as jf:
    json.dump({'train_1':train_set1,'train_2':train_set2,'val':[x for i,x in enumerate(TEST_SCENES) if i%10==0],'test':TEST_SCENES},jf)